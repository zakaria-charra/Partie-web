...
export default class Hotels extends Component {
    ...
    render() {
       ...
       <div className="path"> 
        ...
        <div className="alert alert-success hidden"  id="alertS">
             <strong>Success!</strong> Hotel ajouté avec success
        </div>
  ...
  <div className="row"> 
        <div className="form-group">
          ...
          <div className="col-xs-6">
            <input type="number" className="form-control" id="chamber"  placeholder="Nombre des chambres" onChange={this.onChangeChambre} required/>
          </div>
        </div>
        <div className="form-group">
   ...
   <div className="row">  
        ...
        <div className="form-group">
          ...
          <div className="col-xs-6">
            <input type="number" className="form-control" id="Prix"  placeholder="Prix" onChange={this.onChangePrix}  />
          </div>
        </div>
        <div className="form-group">
    ...
    <div className="row">
        <div className="form-group">
          ...
          <div className="area">
          <textarea  className="form-control" id="Description"  placeholder="Description" onChange={this.onChangeDesc} />
          </div>
        </div>
    </div> 
    ...
    <div className="row">
           <div className="form-group">
              ...
              <input type="file" className="form-control" id="ph3" multiple={true} onChange={this.onChangeph3}  accept="image/*" required /></div>
            </div>
            <div>
